...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  List<String> texts = const [
    'Добро пожаловать! Готовы ли вы присоединиться к захватывающим турам и открыть для себя новые места?',
    'Окунитесь в мир открытий и приключений. Находите удивительные места и создавайте незабываемые воспоминания',
    'Подготовьтесь к приключению! В аренде доступны внедорожники, готовые вас отвести в путь по дорогам и тропам',
