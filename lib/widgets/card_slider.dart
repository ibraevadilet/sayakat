            ...
            children: [
              ...
              for (int i = 0; i < valuesDataIndex.length; i++)
                Container(
                  ...
                  padding:
                      valuesDataIndex[0] == i ? const EdgeInsets.all(3) : null,
                  height: valuesDataIndex[0] == i ? 20 : 15,
                  width: valuesDataIndex[0] == i ? 20 : 15,
                  decoration: BoxDecoration(
                      color: Colors.white,
                      borderRadius: BorderRadius.circular(50),
                      border: valuesDataIndex[0] == i
                          ? Border.all(
